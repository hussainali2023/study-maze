...
<div className="text-center"> <h1 className="text-2xl font-semibold pb-4">Bachelor's Programme</h1>
...
<div className="flex justify-center">
    <Button>Bachelor's Programme</Button>
            ...
            <div data-aos="zoom-in" data-aos-duration="3000">
<div className="flex justify-center"><Image src={logo} className=" w-20" alt=""></Image></div>
<div className="text-center"> <h1 className="text-2xl font-semibold pb-4">Master's Programme</h1>
...
<div className="flex justify-center">
    <Button>Master's Programme</Button>
            ...
            <div data-aos="zoom-in" data-aos-duration="3000">
<div className="flex justify-center"><Image src={logo} className=" w-20" alt=""></Image></div>
<div className="text-center"> <h1 className="text-2xl font-semibold pb-4">PhD's Programme</h1>
